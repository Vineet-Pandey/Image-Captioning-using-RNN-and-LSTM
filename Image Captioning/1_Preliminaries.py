...
##import torch
##features= torch.zeros(10,256)
##features= features.unsqueeze(1)
##print (features.shape) # shape (10,1,256)
##embedd= torch.zeros(10,11,256)
##features= torch.cat((features, embedd),1)
...
print('ouput [0], [1], [2]', outputs.shape[0],outputs.shape[1],outputs.shape[2])
